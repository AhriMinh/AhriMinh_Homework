...
console.log(camelize("duong-quang-minh"));

// BT 2:
//   Viết một hàm sắp xếp giảm dần.

// Sử dụng hai vòng lặp for, để so sánh lồng, lấy ra từng phần tử của dãy so sánh với những phần tử còn lại của dãy đó
// Để thay đổi vị trí thì ta tạo ra biến tạm thời thứ 3 để thực hiện đổi chỗ
...
console.log("Tên của các nhân viên là:", alertName(users));
 // John, Pete, Mary
...
function query4(arr){
  let categoryList = [];
  categoryList.push(arr[0].category);
